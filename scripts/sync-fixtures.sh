...
mkdir -p -- "${DESTINATION}"
# purchase-wire is generated by the Android SDK and must survive an iOS sync.
rsync --archive --delete --exclude /MANIFEST.json --exclude /purchase-wire/ -- \
  "${STAGING}/fixtures/" "${DESTINATION}/"
