...
/** Focused local fixture for renderer-to-Journey publication semantics. */
internal object JourneyTestFixtures {
    val rendererPublication: JsonObject by lazy {
        Json.parseToJsonElement(
            """
            {
              "run": {
                "journey_id": "screen-emission-run-1",
                "experience_id": "screen-emission-experience-1",
                "customer_id": "screen-emission-customer-1",
                "screen_id": "survey",
                "execution_ownership_epoch": 3,
