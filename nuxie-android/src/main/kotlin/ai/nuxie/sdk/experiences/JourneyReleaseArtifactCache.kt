...
internal class JourneyReleaseArtifactAcquisitionException(
    val artifactKey: String,
    val reason: Reason,
    message: String,
    cause: Throwable? = null,
    val httpStatusCode: Int? = null,
) : JourneyReleaseArtifactCache.AcquisitionException(message, cause) {
    enum class Reason {
        INVALID_DESCRIPTOR,
        INVALID_URL,
        HTTP_STATUS,
...
/** Content-addressed storage for authenticated Journey release artifacts. */
internal class JourneyReleaseArtifactCache(
    context: Context,
    ...
    private val baseDir = cacheDirectory
        ?: File((context.applicationContext ?: context).cacheDir, "nuxie/journey_release_objects")
    ...
    fun validateJourneyReleaseDeliveryOrigin(key: String, signedBaseUrl: String) {
    ...
    ): Nothing = throw JourneyReleaseArtifactAcquisitionException(
        key,
        reason,
        message,
        cause,
