...
/** Environment-scoped package trust roots, identical to the iOS release roots. */
internal object ExperienceTrustRoots {
    ...
    private fun decode(value: String): ByteArray = Base64.decode(value, Base64.NO_WRAP)
        .takeIf { it.size == 32 } ?: error("Malformed Nuxie Experience trust root")
}
